...
import {MockWorker} from "./mock_worker.js";
...
/**
 * @param {import("ace-code").EditSession} session
 * @param {Partial<import("../extension").ExtendedSearchOptions>} options
 * @param {(arg0: import("../extension").SearchResultCallbackArgs) => void} cb
 */
export function execFind(session, options, cb) {
    ...
    session.searchTracker.get(options, function (all) {
        ...
        /** @type {import("ace-code").Ace.Position} */
        var start;
        if (!options.start) {
